...
- [ ] GET `/summary` returns HTTP 200 with the summary content and metadata (model used, generation date) from `campaign_summary.json`
- [ ] Returns a 404 or empty response (not an error) if no summary has been generated yet
